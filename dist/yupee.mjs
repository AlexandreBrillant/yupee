...
var hasRequiredYupee;

function requireYupee () {
	if (hasRequiredYupee) return yupee$1.exports;
	hasRequiredYupee = 1;
	(function (module) {
		const $$ = ( ( $$ ) =>  {    
		...
		class Yup {
		    ...
		    */
		    ...
		    paint( html ) {
		        ...
		        ( this.#scrollMode == "end" ) && this.container().scrollToEnd();
	...
	return yupee$1.exports;
}

var yupeeExports = requireYupee();
var yupee = /*@__PURE__*/getDefaultExportFromCjs(yupeeExports);

export { yupee as default };
